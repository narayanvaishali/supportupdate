...
function AddSupportUpdate () {
      ...
      // our success handler when all items are validated
        ...
        const submit = useSubmit([staffemail, zdid, dateworked], handleSuccess);
          ...
          return ( <Paper className={classes.root} >
                    ...
                    <form className={classes.form} {...submit.props}>
                        <Grid item>
                             <TextField label="Email" variant="outlined" {...staffemail.props} />
                        ...
                        <Grid item><br/></Grid>
                        <Grid item>
                                <TextField label="ZD ID" variant="outlined" {...zdid.props} />
                                    {zdid.props.error && (
                                        <Typography variant="body1" color="error">
                                        Invalid ZD ID
                                        </Typography>
                        ...
                        <Grid item><br/></Grid>
                        <Grid item>
                                <TextField label="Date Worked" variant="outlined" {...dateworked.props} />
                                 ...
                                 {/* <TextField label="Date Worked" variant="outlined"  /> */}
